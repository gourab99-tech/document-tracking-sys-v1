...
public class ReceiveSubmitAcction extends javax.swing.JFrame {
    ...
    public void sub() {
        ...
        jComboBoxField.addItemListener(ie -> {
            if (ie.getStateChange() == ItemEvent.SELECTED) {
                if (Objects.requireNonNull(jComboBoxField.getSelectedItem()).toString().equalsIgnoreCase("Send to All")) {
    ...
    private void initComponents() {
        ...
        jButtonReturn.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/document_tracking_system/images/Go Back_22px.png"))));
        ...
        jButtonSubmit.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/document_tracking_system/images/forward.png"))));
        ...
        jLabel12.setFont(new java.awt.Font("Arial", Font.PLAIN, 14));
        jLabel12.setForeground(new java.awt.Color(102, 102, 102));
        jLabel12.setText("Submission");

        jLabel13.setBackground(new java.awt.Color(102, 102, 102));
        jLabel13.setFont(new java.awt.Font("Arial", Font.PLAIN, 16));
        jLabel13.setForeground(new java.awt.Color(102, 102, 102));
        jLabel13.setText("Submit Document");

        jLabel6.setFont(new java.awt.Font("Arial", Font.PLAIN, 13));
        ...
        jComboBoxPermission.addActionListener(this::jComboBoxPermissionActionPerformed);

        jLabel17.setFont(new java.awt.Font("Arial", Font.PLAIN, 13));
        jLabel17.setText("Field:");

        jButtonDone.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/document_tracking_system/images/Ok_22px.png"))));
    ...
    public void SaveToOutGoing() {
        ...
        try {
            ...
            String tosend = Objects.requireNonNull(jComboBoxPermission.getSelectedItem()).toString();
            String time = jLabelTime.getText().trim();
    ...
    public void saveToPendingList() {
        ...
        try {
            ...
            String from_data = jTextFieldFrom.getText().trim();
            String by_data = jTextFieldBy.getText().trim();
            String to_data = Objects.requireNonNull(jComboBoxPermission.getSelectedItem()).toString();
            String type_data = jTextDoctype.getText().trim();
            String purpose_data = jTextAreaPurpose.getText().trim();
            String Details = jTextAreaDetails.getText().trim();
            String postedTime = jLabelTime.getText().trim();
    ...
    private void jTextFieldFromActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void jComboBoxPermissionActionPerformed(java.awt.event.ActionEvent evt) {
        jButtonSubmit.setEnabled(true);
        jButtonReturn.setEnabled(false);
        jButtonDone.setEnabled(false);
...
// TODO add your handling code here:
    ...
    private void jButtonSubmitKeyReleased(java.awt.event.KeyEvent evt) {
